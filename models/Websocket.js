            ...
            switch (key) {
                case 'score':
                    for (team in msgJson[key]) {
                        for (type in msgJson[key][team]) {
                            Game.updateScore(team, type, msgJson[key][team][type]);
                            console.log("Setting: " + team + " " + type + ": " + msgJson[key][team][type]);
                        }
                    }
                    break;
                case 'startClock':
                ...
                case 'setTeamName':
                    for (team in msgJson[key]) {
                        if (team == 'home' || team == 'away') {
                            ...
                            Game.teams[team].updateInfo(msgJson[key][team], null);
                        }
                    }                    
                    break;
                case 'setTeamColour':
                    for (team in msgJson[key]) {
                        if (team == 'home' || team == 'away') {
                            ...
                            Game.teams[team].updateInfo(null, msgJson[key][team]);
                        }
                    }                    
                    break;
                case 'resetGame':
                    var p = {
                            ...
                            awayTeamName        : '',
                            awayTeamColour      : null,
                            periodLengthSec     : 1800,
                            halftimeLengthSec   : 600,                        
                    };                    
                    ...
                    Game.resetGame(p.homeTeamName, p.homeTeamColour, p.awayTeamName, p.awayTeamColour, p.periodLengthSec, p.halftimeLengthSec);
                    break;
